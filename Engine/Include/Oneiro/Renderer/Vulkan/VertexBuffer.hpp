...
namespace oe::Renderer::Vulkan
{
    ...
    {
      public:
        template <class T> void Create(const std::vector<T>& vertices);
        void Bind() const;
        void Destroy();
    ...
    template <class T> void VertexBuffer::Create(const std::vector<T>& vertices)
    {
        ...
        Buffer::Create(size, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_VERTEX_BUFFER_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
