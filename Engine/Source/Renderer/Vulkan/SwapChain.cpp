...
namespace
{
    void CreateSwapChainInfo(uint32_t imageCount, VkSurfaceFormatKHR surfaceFormat, VkSurfaceCapabilitiesKHR capabilities,
                             VkPresentModeKHR presentMode, VkExtent2D extent, VkSwapchainCreateInfoKHR& createInfo);
}
