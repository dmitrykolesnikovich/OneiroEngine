...
{
    void Buffer::Create(VkDevice device, VkDeviceSize size, VkBufferUsageFlags usage,
    ...
    void Buffer::Copy(VkDevice device, VkCommandPool commandPool, VkBuffer srcBuffer, VkBuffer dstBuffer,
